    ...
    return (
        <div className="relative w-full md:w-80">
            ...
            <input
                ...
                className="w-full pl-11 pr-10 py-2.5 bg-white border border-safari-100 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-secondary-500/20 focus:border-secondary-500 transition-all shadow-sm"
            />
            {query && (
                <button
                    onClick={clearSearch}

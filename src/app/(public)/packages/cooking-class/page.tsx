                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 sm:gap-6 md:gap-8 w-full md:w-auto">
                        <div className="text-center md:text-left">
                            ...
                            <div className="text-2xl sm:text-3xl font-bold text-secondary-600">
                                USD 22 <span className="text-safari-400 text-sm sm:text-base font-normal">/ person</span>
                            </div>
                        </div>
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <div className="text-base sm:text-lg font-bold text-safari-800 flex items-center gap-1">
                                <DollarSign size={16} className="text-secondary-600" /> USD 5
                            </div>
                        </div>
                    </div>
                    <Link

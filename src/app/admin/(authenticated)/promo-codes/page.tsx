    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-safari-900">Promo Codes</h1>
                    <p className="text-safari-500 mt-1">Manage discount codes and coupons</p>
                </div>
                <button
                    onClick={handleCreate}
                    className="flex items-center gap-2 bg-secondary-600 hover:bg-secondary-700 text-white px-6 py-3 rounded-xl font-bold shadow-lg shadow-secondary-900/20 transition-all hover:-translate-y-1"
                >
                    <Plus size={20} />
                    Create New Code
                </button>
            ...
            <div className="bg-white rounded-2xl border border-safari-100 shadow-xl overflow-hidden">
                <div className="p-4 border-b border-safari-100 bg-safari-50/50">
                    <div className="relative max-w-md">
                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-safari-400" size={20} />
                        <input
                            type="text"
                            placeholder="Search promo codes..."
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                            className="w-full pl-10 pr-4 py-2 rounded-xl border border-safari-200 focus:border-secondary-500 outline-none"
                        />
                    </div>
                </div>

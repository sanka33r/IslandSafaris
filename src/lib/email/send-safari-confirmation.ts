    ...
    <div style="background:#fff; border-radius:16px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.06); border:1px solid #eee;">
      ...
      <div style="padding:24px;">
        ...
        <div style="margin-top:20px; padding:14px 16px; background:#fff8e6; border:1px solid #f0dca0; border-radius:10px;">
          <p style="margin:0; font-size:14px; font-weight:600; color:#7a5c00;">Pick up point: ${payload.destinationName} Safari Entrance gate</p>
          <p style="margin:6px 0 0; font-size:13px; color:#8a6d00;">Please be at the entrance gate by ${timeFormatted}.</p>
        </div>` : ''}
